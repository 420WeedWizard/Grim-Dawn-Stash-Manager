Public Class Form1
    ...
    Dim GSTFile As String = SaveLocation & "transfer.gsh"
    Dim AppPath As String = Application.StartupPath
    Dim ConfigPath As String = AppPath & "\optionsHC.cfg"
    Dim GSTInfo As String = AppPath & "\GSH.cfg"
    Dim GSTFiles As String = AppPath & "\gsh"
    Dim HotkeyInfo As String = Application.StartupPath & "\hotkeyHC.cfg"
    ...
    Private Sub AddGSTFile()
        ...
        FileS.Filter = "Grim Dawn Stash File - Hardcore(*.gsh)|*.gsh|All files (*.*)|*.*"
        FileS.ShowDialog()
    ...
    Private Sub AddEmptyStash()
        ...
        Dim EmptyStash As String = AppPath & "\emptyStashPreset.gsh"
